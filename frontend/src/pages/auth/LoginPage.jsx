      ...
      <div className="hidden lg:flex lg:w-[42%] relative border-r border-border items-center justify-center">
        ...
        <div className="relative w-full max-w-[500px] h-full py-12 px-12 xl:px-0 flex flex-col justify-center z-content">
          ...
          <div className="flex flex-col">
            <h1 className="text-3xl lg:text-3xl xl:text-[40px] font-bold leading-[1.1] tracking-tight mb-8 2xl:mb-[40px] animate-fade-in-up bg-clip-text text-transparent bg-gradient-to-br from-white via-white to-white/40 drop-shadow-sm">
