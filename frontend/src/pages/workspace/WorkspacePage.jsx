  ...
  return (
    <div className="px-4 sm:px-6 py-8 animate-fade-in-up">
      ...
      <div className="mb-8">
        <button 
          onClick={() => navigate('/dashboard')}
          className="flex items-center gap-2 text-sm text-[var(--color-text-tertiary)] hover:text-[var(--color-text-primary)] mb-6 transition-colors"
        >
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          <div className="flex items-center gap-5">
            <div className={cn(
              ...
              currentWorkspace.color || "from-indigo-500 to-purple-600"
            )}>
          ...
          <button className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-indigo-500 hover:bg-indigo-600 text-white font-medium text-sm transition-colors shadow-lg shadow-indigo-500/25">
      ...
      <div className="mt-12">
        ...
        {projLoading ? (
          ...
          <div className="bg-[var(--color-bg-card)] rounded-xl border border-[var(--color-border)] border-dashed p-12 text-center">
            ...
            <button className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg border border-[var(--color-border)] bg-[var(--color-bg-secondary)] hover:bg-[var(--color-bg-tertiary)] text-[var(--color-text-primary)] font-medium text-sm transition-colors cursor-pointer">
